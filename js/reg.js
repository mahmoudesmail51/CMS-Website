$(document).ready(function(){
    $("#submit").click(function(){
        ...
        if(firstname == "" || !isNameValid(firstname)){
            valid = false;
            $("#errorFirstname").html("<div class='alert alert-danger email_alert' style='margin-top:10px;'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times</a>Firstname Cannot Be Blank and Must Be Between 7 and 15 Characters</div>");
        }else{
            $("#errorFirstname").html("");
        }
        ...
        if(lastname == "" || !isNameValid(lastname)){
            valid = false;
            $("#errorLastname").html("<div class='alert alert-danger email_alert' style='margin-top:10px;'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times</a>Lastname Cannot Be Blank and Must Be Between 7 and 15 Characters</div>");
